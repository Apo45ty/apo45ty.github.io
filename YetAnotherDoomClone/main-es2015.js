...
let DatabaseGetterService = class DatabaseGetterService {
    ...
    getYoutubeVideos() {
        let a = this.http.get('https://www.googleapis.com/youtube/v3/playlistItems?part=contentDetails&playlistId=PL-adq2z_Lky_4fjk9r2W1A8WjduaYUByX&key=AIzaSyDXCDiwzvvC0hgqXatyZyWdiViORRV54Bs', {});
        a.subscribe(data => {
...
module.exports = __webpack_require__(/*! C:\Users\anton\OneDrive\Documents\angular2Projects\YADCLandingPage\src\main.ts */"./src/main.ts");
