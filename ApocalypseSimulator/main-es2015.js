...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<nav class=\"\"  >\n  <div style=\"text-align: center;\">\n    <a href=\"http://apolion.games\">\n      <h2>Welcome to Apocalypsis Simulator</h2>\n    </a>\n  </div>\n</nav>");
...
/* harmony import */ var _fullpage_fullpage_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./fullpage/fullpage.component */ "./src/app/fullpage/fullpage.component.ts");
...
const routingComponents = [_fullpage_fullpage_component__WEBPACK_IMPORTED_MODULE_3__["FullpageComponent"], _landingpage_landingpage_component__WEBPACK_IMPORTED_MODULE_4__["LandingpageComponent"]];
...
/* harmony import */ var _database_getter_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./database-getter.service */ "./src/app/database-getter.service.ts");
/* harmony import */ var _app_routing_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./app-routing.module */ "./src/app/app-routing.module.ts");
/* harmony import */ var _navbar_navbar_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./navbar/navbar.component */ "./src/app/navbar/navbar.component.ts");
/* harmony import */ var _landingpage_landingpage_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./landingpage/landingpage.component */ "./src/app/landingpage/landingpage.component.ts");
/* harmony import */ var _SafePipe__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./SafePipe */ "./src/app/SafePipe.ts");
/* harmony import */ var angular2_recaptcha__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! angular2-recaptcha */ "./node_modules/angular2-recaptcha/angular2-recaptcha.js");
/* harmony import */ var angular2_recaptcha__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(angular2_recaptcha__WEBPACK_IMPORTED_MODULE_11__);
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _SafePipe__WEBPACK_IMPORTED_MODULE_10__["SafePipe"]
        ],
        imports: [
            ...
            angular2_recaptcha__WEBPACK_IMPORTED_MODULE_11__["ReCaptchaModule"]
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DatabaseGetterService", function() { return DatabaseGetterService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
/* harmony import */ var _angular_platform_browser___WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/platform-browser/ */ "./node_modules/@angular/platform-browser/fesm2015/platform-browser.js");
...
let DatabaseGetterService = class DatabaseGetterService {
    ...
    registerUser(user) {
        ...
        let a = this.http.post(this.endpoint + '/register', user, httpOptions);
        a.subscribe(data => {
            console.log(data);
        }, error => {
    ...
    getToken(user) {
        let a = this.http.post(this.endpoint + '/login', user);
        a.subscribe(data => {
    ...
    getUsers() {
        let a = this.http.get(this.endpoint + '/users', {
    ...
    getYoutubeVideos() {
        let a = this.http.get('https://www.googleapis.com/youtube/v3/playlistItems?part=contentDetails&playlistId=PL-adq2z_Lky8-HDgYDmfu8VVbW52Yv0Su&key=AIzaSyDXCDiwzvvC0hgqXatyZyWdiViORRV54Bs', {});
        a.subscribe(data => {
...
DatabaseGetterService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"] },
    { type: _angular_platform_browser___WEBPACK_IMPORTED_MODULE_7__["DomSanitizer"] }
];
DatabaseGetterService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _database_getter_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../database-getter.service */ "./src/app/database-getter.service.ts");
/* harmony import */ var _User__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../User */ "./src/app/User.ts");
/* harmony import */ var angular2_recaptcha__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! angular2-recaptcha */ "./node_modules/angular2-recaptcha/angular2-recaptcha.js");
/* harmony import */ var angular2_recaptcha__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(angular2_recaptcha__WEBPACK_IMPORTED_MODULE_4__);





let FullpageComponent = class FullpageComponent {
    ...
    submitEmail(email) {
        ...
        this._databaseService.registerUser(new _User__WEBPACK_IMPORTED_MODULE_3__["User"]("alphaemail", "", email));
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(angular2_recaptcha__WEBPACK_IMPORTED_MODULE_4__["ReCaptchaComponent"], { static: false })
], FullpageComponent.prototype, "captcha", void 0);
FullpageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-fullpage',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./fullpage.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/fullpage/fullpage.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./fullpage.component.css */ "./src/app/fullpage/fullpage.component.css")).default]
    })
], FullpageComponent);
...
let LandingpageComponent = class LandingpageComponent {
    constructor(_databaseService, router) {
        this._databaseService = _databaseService;
        this.router = router;
    }
    ngOnInit() {
...
module.exports = __webpack_require__(/*! C:\Users\anton\OneDrive\Documents\angular2Projects\ApocalypsisSimulatorLandingPage\src\main.ts */"./src/main.ts");
